...
const UserDashboard = () => {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-24 pb-12 px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-dark-600">Manage your orders, appointments, and profile</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-dark-600 text-sm mb-1">Appointments</p>
        ...
        <div className="glass-card rounded-2xl p-6">
          {loading ? (
            ...
            <>
              ...
              {activeTab === 'orders' && (
                <div className="space-y-4">
                  <h2 className="text-2xl font-bold text-dark-900 mb-4">Your Orders</h2>
                  {orders.length === 0 ? (
                    ...
                    orders.map((order) => (
                      <motion.div
                        key={order.id}
                        whileHover={{ x: 4 }}
                        className="glass-card-hover rounded-xl p-6 border border-dark-200 border border-dark-200 border border-dark-200"
                      >
  ...
  {formatINR(item.totalPrice)}
              ...
              {activeTab === 'appointments' && (
                <div className="space-y-4">
                  <h2 className="text-2xl font-bold text-dark-900 mb-4">Your Appointments</h2>
                  {appointments.length === 0 ? (
                    ...
                    appointments.map((appointment) => (
                      <motion.div
                        key={appointment.id}
                        whileHover={{ x: 4 }}
                        className="glass-card-hover rounded-xl p-6 border border-dark-200 border border-dark-200"
                      >
              ...
              {activeTab === 'profile' && (
                <div className="space-y-6">
                  <h2 className="text-2xl font-bold text-dark-900 mb-4">Your Profile</h2>
                  ...
                  <div className="pt-6 border-t border-dark-200">
                    <h3 className="text-lg font-semibold text-dark-900 mb-4">Account Actions</h3>
